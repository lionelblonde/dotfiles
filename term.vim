...
hi NeogitBranch ctermfg=10 ctermbg=0 cterm=bold
hi NeogitDiffAddHighlight ctermfg=0 ctermbg=10 cterm=NONE
hi NeogitDiffContextHighlight ctermfg=7 ctermbg=0 cterm=NONE
hi NeogitDiffDeleteHighlight ctermfg=15 ctermbg=9 cterm=NONE
